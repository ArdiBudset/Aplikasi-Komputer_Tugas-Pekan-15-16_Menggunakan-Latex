...
\begin{eulercomment}
Dalam notebook ini, kami mendemonstrasikan plot statistik utama,
...
>boxplot(M):
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-005.png}
\eulerheading{Tabel}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
Tabel berisi 7 kolom angka atau tanda (string). Kami ingin membaca
tabel dari file. Pertama, kami menggunakan terjemahan kami sendiri
untuk tanda.

Untuk ini, kami mendefinisikan set tanda. Fungsi strtokens()
...
\end{eulerprompt}
\begin{eulercomment}
Tentu saja, kita juga dapat menggunakannya untuk menentukan nilai mean
kolom atau nilai statistik lainnya.
\end{eulercomment}
\begin{eulerprompt}
>mean(tablecol(MT,6))
\end{eulerprompt}
...
\end{eulercomment}
\begin{eulerprompt}
>p=normal(1,1000); //1000 sampel acak terdistribusi normal p
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-009.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-012.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-014.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
\end{euleroutput}
\begin{eulercomment}
Fungsi qchidis() adalah densitas dari distribusi chi-kuadrat. Seperti
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-017.png}
\begin{eulercomment}
...
- fungsi balikannya adalah invchidis(),\\
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-018.png}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
Fungsi Balikan Beta digunakan untuk menghitung interval kepercayaan
...
\end{euleroutput}
\begin{eulercomment}
Omong-omong, invbinsum() menghitung balikan dari binomialsum().
\end{eulercomment}
\begin{eulerprompt}
...
pertama adalah tahun pemilihan.
\end{eulercomment}
\begin{eulerprompt}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-020.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-021.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-022.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-023.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-029.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-030.png}
\begin{eulercomment}
...
\end{euleroutput}
\begin{eulercomment}
Kemudian ekstrak angka tunggal di v.
\end{eulercomment}
\begin{eulerprompt}
>vu:=unique(v)
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-031.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-033.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-034.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-035.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-038.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-039.png}
\begin{eulercomment}
Sangat menarik bahwa perbedaan median tidak sebesar perbedaan mean.
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-043.png}
\begin{eulercomment}
Median 10 0-1-bilangan acak terdistribusi normal memiliki deviasi yang
lebih besar.
\end{eulercomment}
\begin{eulerprompt}
>dev(median(M)')
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-044.png}
\eulerheading{Tes}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-045.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
sama. Metode tersebut disebut ANOVA (analysis of varians). Di Euler,
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-046.png}
\begin{eulercomment}
Hapus datanya.
\end{eulercomment}
\begin{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
String di R dan EMT sama. Keduanya berada di lokal saat ini, bukan di
Unicode.
...
\begin{eulercomment}
Sebagian data besar, ini akan berfungsi seperti pada R.
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-048.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-049.png}
\eulerheading{Daftar}
\begin{eulercomment}
...
\begin{euleroutput}
  A,B,C
  0.2325146620924334,0.5175800868283525,0.8399218481003107
  0.336655122980329,0.6942166504489329,0.7277428530427359
  0.06026396393889418,0.8443897421346642,0.7763524944847273
...
\begin{euleroutput}
           A         B         C
     0.23251   0.51758   0.83992
     0.33666   0.69422   0.72774
     0.06026   0.84439   0.77635
\end{euleroutput}
\begin{eulercomment}
Nilai matriks adalah elemen pertama dari L. Perhatikan bahwa mean()
dalam EMT menghitung nilai mean dari baris matriks.
\end{eulercomment}
\begin{eulerprompt}
>mean(L[1])
\end{eulerprompt}
...
\end{eulerprompt}
\begin{euleroutput}
  0.3197946130216783,0.5787845944039014,0.2737923526542028
  0.3671130231603081,0.5275695458256693,0.6525304249790899
  0.7917330834536404,0.8603155045429328,0.527472095021572
  
\end{euleroutput}
\begin{eulercomment}
CSV ini dapat dibuka pada sistem bahasa Inggris ke Excel dengan klik
...
\end{eulerprompt}
\begin{euleroutput}
    0.31979   0.57878   0.27379 
    0.36711   0.52757   0.65253 
    0.79173   0.86032   0.52747 
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/Ardi Budi_Statistika-050.png}
\begin{eulercomment}
...
\begin{euleroutput}
  M = [ ..
  0.01913630293057568, 0.6209753033625431;
  0.1491428602846074, 0.3307128786624384];
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  [0.70965,  0.502826,  0.5306,  0.211331,  0.419245]
\end{euleroutput}
\eulerheading{Beberapa analisis data statistika dari buku}
\begin{eulerprompt}
> 
\end{eulerprompt}
\end{eulernotebook}
