...
\begin{eulerttcomment}
   - * Judul
   - ** Sub-Judul
   - miktex: F (x) = \(\backslash\)int_a^x f (t) \(\backslash\), dt
...
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{Jawaban Latihan diatas :}
\begin{eulerprompt}
>a=2, b=4, c=7
\end{eulerprompt}
\begin{euleroutput}
...
- Pilih baris komentar yang ingin disisipkan, lalu klik pada baris
perintah yang ada dibawah baris komentar tersebut.\\
- Setelah itu, pilih 'Extras' lalu pilih 'Edit komentar' atau bisa
langsung klik F5.\\
- Setelah itu, pilih bagian mana yang akan disisipkan baris komentar :\\
#contoh :
...
- Kemudian, blok kebawah pada baris 'Beberapa catatan yang harus
Anda...' sampai kebawah. Lalu, klik CTRL+C untuk menyalin teks itu.
Lalu hapus.\\
- Kemudian, keluar dari ekstras. Lalu, klik baris perintah tadi
lakukan CTRL + SHIFT + ENTER pada depan kalimat perintah. (Otomatis
akan membuat baris perintah baru.\\
- Setelah itu edit komentar lagi pada baris perintah yang lama. Paste
kalimat yang tadi disalin. lalu OK, maka otomatis akan ada baris
perintah yang tersisipkan antara paragraf tadi.
...
\begin{euleroutput}
  ...
  0.444616,  0.299474,  0.28269,  0.883227]
\end{euleroutput}
\begin{eulerprompt}
>A = [1,4,2; 4,3,7; 9,6,3] // penulisan matriks
\end{eulerprompt}
\begin{euleroutput}
              1             4             2 
              4             3             7 
...
\end{eulercomment}
\eulersubheading{Latihan dari soal-soal matematika}
\begin{eulercomment}
1. Carilah nilai x dari persamaan x\textasciicircum{}2 + 4*x + 6 = 0 !
\end{eulercomment}
\begin{eulerprompt}
>$&solve(1*x^2 + 3*x + 18 = 0,x) // rumus abc
\end{eulerprompt}
\begin{eulerformula}
\[
\left[ x=\frac{-3\,\sqrt{7}\,i-3}{2} , x=\frac{3\,\sqrt{7}\,i-3}{2}
  \right] 
\]
\end{eulerformula}
\begin{eulercomment}
2. Tentukan turunan dari x\textasciicircum{}2*cos(y\textasciicircum{}3*x) !
\end{eulercomment}
\begin{eulerprompt}
>$&diff(x^2*cos(y^3*x),x)
\end{eulerprompt}
\begin{eulerformula}
\[
2\,x\,\cos \left(x\,y^3\right)-x^2\,y^3\,\sin \left(x\,y^3\right)
\]
\end{eulerformula}
\begin{eulerprompt}
>$&diff(x^2*cos(y^3*x),y)
\end{eulerprompt}
\begin{eulerformula}
\[
-3\,x^3\,y^2\,\sin \left(x\,y^3\right)
\]
\end{eulerformula}
\begin{eulercomment}
3. Tentukan integral dari persamaan 1/(1-x\textasciicircum{}2) !
\end{eulercomment}
\begin{eulerprompt}
>$&integrate(1/(1-x^2),x)
\end{eulerprompt}
\begin{eulerformula}
\[
\frac{\log \left(x+1\right)}{2}-\frac{\log \left(x-1\right)}{2}
\]
\end{eulerformula}
\begin{eulercomment}
4. Tentukan rata-rata dari himpunan H!
\end{eulercomment}
\begin{eulerprompt}
>h=254:328
\end{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
5. Tentukan faktor dari 10 faktorial !
\end{eulercomment}
\begin{eulerprompt}
>factor(10!)
\end{eulerprompt}
